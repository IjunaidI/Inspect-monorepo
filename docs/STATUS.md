...
> (generic "Unable to load reports") — retry before blaming code. **Steps 1–3 of the handoff (CI read,
> Railway deploy, EAS device build) remain user-side blocked** — `gh` is still unauthenticated.
>
