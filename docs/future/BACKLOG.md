...
- status: todo            # NEW 2026-07-18 (final whole-branch review of meeting batch 1)
...
- status: todo            # NEW 2026-07-25 (reported live: admin login 403s on /dashboard)
...
- refs: spec [../in-progress/specs/2026-07-25-inspect-platform-admin-org-assumption-design.md](../in-progress/specs/2026-07-25-inspect-platform-admin-org-assumption-design.md) · closes INS-078 as a consequence · accepted risk: an assumed admin can make binding QA decisions inside a tenant (mitigated by attribution, not prevention) · the narrower alternatives considered and declined were a read-only cross-tenant overview and an onboarding-only console.
